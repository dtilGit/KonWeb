...
<body>
	...
	<section>
		<div class="intro">
			Adminpage: Artikel anpassen <br> How to: kurze Beschreibung zum
			Bearbeiten<br>
			<br>
			<br> Lager:
		</div>

		<form id="AlleArtikelLaden" method="post"
			enctype="multipart/form-data" action="/servlets/AlleArtikelLaden">
		...
		<div id="adminpagebutton">
			<button type="button" id="lager_erhoehen"
				onClick="document.getElementById('lager_befuellen').style.display='inline';">Lagerbestand
				erhöhen</button>
			<button type="button" id="neuer_artikel"
				onClick="document.getElementById('ArtikelHinzufuegen').style.display='inline';">neuen
				Artikel hinzufügen</button>
			<button type="button" id="neue_kategorie"
				onClick="document.getElementById('KategorieHinzufuegen').style.display='inline';">Kategorie
				hinzufügen</button>
			<form action="../AlleKategorienLaden" method="post"
				enctype="multipart/form-data">
				<button type="submit" id="kategorien_laden">Kategorien
					laden</button>
			</form>
			<form action="../AlleArtikelLaden" method="post"
				enctype="multipart/form-data">
				<button type="submit" id="artikel_laden">Artikel laden</button>
			</form>
			<button type="button" id="neue_kategorie"
				onClick="document.getElementById('KategorieLoeschen').style.display='inline';">Kategorien
				löschen</button>
			<button type="button" id="neuer_artikel"
				onClick="document.getElementById('ArtikelLoeschen').style.display='inline';">Artikel
				löschen</button>
		</div>
				...
				<table id="ArtikelHinzufuegen" style="display: none">
					...
					<tbody>
						<tr>
							...
							<td>
								<div>
									<label for="bild">Bild hochladen:</label> <input type="file"
										name="bild" id="bild" accept="image/*" required>
