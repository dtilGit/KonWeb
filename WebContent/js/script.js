	...
	if(nachname.match(zahlen)){
		 ...
		 event.preventDefault();
			return;
			 ...
			 throw "Nachname korrekt!";
		 }
	
	if(vorname.match(zahlen)){
		 ...
		 event.preventDefault();
			return;
			 ...
			 throw "Vorname korrekt!";
		 }
	
	if(strasse.match(zahlen)){
