 ...
 */
@WebServlet("/ArtikelLadenMen")
public class ArtikelLadenMen extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		dispatcher = request.getRequestDispatcher("user/artikelMen.jsp");
